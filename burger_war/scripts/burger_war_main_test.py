...
class test_calc_distance():
    ...
    def remake_target_list(self, my_trans):
        distance_list = []
        for pos in self.check_points:
            distance_list.append(self.calc_distance(my_trans, pos))
            #print(pos)
            #print(self.calc_distance(my_trans, pos))
...
if __name__ == "__main__":
    ...
    t.remake_target_list(my_trans)
    print(t.check_points)
